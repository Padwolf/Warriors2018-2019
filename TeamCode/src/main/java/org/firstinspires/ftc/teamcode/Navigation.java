...
public class Navigation {
    ...
    public List<VuforiaTrackable> visibleImages;
    ...
    public void initialize(HardwareMap hardwareMap) {
        ...
        {
            ((VuforiaTrackableDefaultListener)trackable.getListener()).setCameraLocationOnRobot(webcamName, phoneLocationOnRobot);
        }

        visibleImages = new ArrayList<VuforiaTrackable>();
    }
